...
Project-specific acceptance focus: Define RPO/RTO and test scheduled backup, immutability, deletion resistance, key rotation, namespace and full-cluster restore, corrupted backup, cross-region recovery, version skew, and secret handling.
